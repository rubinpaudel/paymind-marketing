      ...
      <div className="container flex flex-col gap-4">
        <section className="space-y-6">
          ...
          <p className="text-xs sm:text-sm text-muted-foreground">
            AGREEMENT TO OUR LEGAL TERMS We are Paymind , a company registered
            in Belgium in Bruges, West-Vlaanderen 8310. We operate the website
            http://www.paymind.be , the mobile application Paymind (the
            &#39;App&#39;), as well as any other related products and services
            that refer or link to these legal terms (the &#39;Legal Terms&#39;)
            (collectively, the &#39;Services&#39;).
          </p>
          <p>
            Our AI platform provides information from various Belgian social law
            platforms according to the questions of our users. We deliver
            information according to the requests of our users. You can contact
            us by email at info@paymind.be. These Legal Terms constitute a
            legally binding agreement made between you, whether personally or on
            behalf of an entity (&#39;you&#39;), and Paymind, concerning your
          ...
          <p>
            ...
            18) must have permission, and be directly supervised by, their
            ...
            prior to you using the Services. We recommend that you print a copy
            of these Legal Terms for your records.
          </p>
        </section>
        {/* TOC */}
        <section>
          <h2 className="font-heading text-xl">Table of contents</h2>
          <ul className="list-disc pl-4 space-y-2">
            ...
            <li>
              <a href="#purchases-payment">5. Purchases and Payment</a>
            </li>
            <li>
              <a href="#subscriptions">6. Subscriptions</a>
            </li>
            <li>
              <a href="#prohibited-activities">7. Prohibited Activities</a>
            </li>
            <li>
              <a href="#user-contributions">8. User Generated Contributions</a>
            </li>
            <li>
              <a href="#contribution-license">9. Contribution Licence</a>
            </li>
            <li>
              <a href="#review-guidelines">10. Guidelines for Reviews</a>
            </li>
            <li>
              <a href="#mobile-app-license">11. Mobile Application Licence</a>
            </li>
            <li>
              <a href="#social-media">12. Social Media</a>
            </li>
            <li>
            ...
            <li>
              <a href="#term-termination">16. Term and Termination</a>
            </li>
            <li>
            ...
            <li>
              <a href="#contact-us">27. Contact Us</a>
            </li>
          </ul>
        </section>
        <section className="space-y-4 text-sm md:text-base">
          <div id="services" className="space-y-2">
            ...
            <p>
              ...
              Accordingly, those people who choose to access the Services from
          ...
          <div id="intellectual-property" className="space-y-2">
            ...
            <p>
              ...
              internal business purpose only. Your use of our Services Subject
              ...
              personal, non-commercial use or internal business purpose. Except
              as set out in this section or elsewhere in our Legal Terms, no
              ...
              address your request to: info@paymind.be. If we ever grant you the
              ...
              use our Services will terminate immediately. Your submissions
              ...
              or upload any content through the Services. Submissions: By
              ...
              without acknowledgment or compensation to you. You are responsible
              for what you post or upload: By sending us Submissions through any
              part of the Services you: confirm that you have read and agree
              ...
              rights and licences to submit such Submissions and that you have
              full authority to grant us the above-mentioned rights in relation
              to your Submissions; and warrant and represent that your
          ...
          <div id="user-representations" className="space-y-2">
          ...
          <div id="user-registration" className="space-y-2">
            <h3 className="text-lg">4. User Registration</h3>
            <p>
          ...
          <div id="purchases-payment" className="space-y-2">
            <h3 className="text-lg">5. Purchases and Payment</h3>
            <p>
              We accept the following forms of payment: - Visa - Mastercard You
              ...
              have already requested or received payment. We reserve the right
              to refuse any order placed through the Services. We may, in our
              ...
              our sole judgement, appear to be placed by dealers, resellers, or
              distributors.
            </p>
          </div>
          <div id="subscriptions" className="space-y-2">
            <h3 className="text-lg">6. Subscriptions</h3>
            <p>
              ...
              subscribed to the Services. Free Trial We offer a 30-day free
              trial to new users who register with the Services. The account
              will be charged according to the user&#39;s chosen subscription at
              ...
              unsatisfied with our Services, please email us at info@paymind.be.
          ...
          <div id="prohibited-activities" className="space-y-2">
            <h3 className="text-lg">7. Prohibited Activities</h3>
            <p>
              ...
              &#39;pcms&#39;). Interfere with, disrupt, or create an undue
              ...
              other code. Except as permitted by applicable law, decipher,
              decompile, disassemble, or reverse engineer any of the software
              comprising or in any way making up a part of the Services. Except
              ...
              launch any unauthorised script or other software. Use a buying
              agent or purchasing agent to make purchases on the Services. Make
              ...
              endeavour or commercial enterprise. Use the Services to advertise
              or offer to sell goods and services. Sell or otherwise transfer
              your profile.
            </p>
          </div>
          <div id="user-contributions" className="space-y-2">
            ...
            <p>
              ...
              necessary licences, rights, consents, releases, and permissions to
              use and to authorise us, the Services, and other users of the
              Services to use your Contributions in any manner contemplated by
              the Services and these Legal Terms. You have the written consent,
              ...
              Services in violation of the foregoing violates these Legal Terms
              and may result in, among other things, termination or suspension
              of your rights to use the Services.
            </p>
          </div>
          <div id="contribution-license" className="space-y-2">
          ...
          <div id="review-guidelines" className="space-y-2">
            ...
            <p>
              ...
              review, you hereby grant to us a perpetual, nonexclusive,
          ...
          <div id="mobile-app-license" className="space-y-2">
            <h3 className="text-lg">11. Mobile Application Licence</h3>
            <p>
              Use Licence If you access the Services via the App, then we grant
              ...
              (5) use the App for any revenuegenerating endeavour, commercial
              ...
              applications, accessories, or devices for use with the App. Apple
              ...
              &#39;App Distributor&#39;) to access the Services: (1) the licence
              ...
              licence contained in these Legal Terms or as otherwise required
          ...
          <div id="social-media" className="space-y-2">
            <h3 className="text-lg">12. Social Media</h3>
            <p>
              As part of the functionality of the Services, you may link your
              account with online accounts you have with third-party service
              providers (each such account, a &#39;ThirdParty Account&#39;) by
              ...
              THIRDPARTY SERVICE PROVIDERS ASSOCIATED WITH YOUR THIRD-PARTY
          ...
          <div id="third-party-websites" className="space-y-2">
            <h3 className="text-lg">13. Third-Party Websites and Content</h3>
            <p>
              ...
              checked for accuracy, appropriateness, or completeness by us, and
              ...
              with ThirdParty Websites.
            </p>
          </div>
          <div id="services-management" className="space-y-2">
            <h3 className="text-lg">14. Services Management</h3>
            <p>
          ...
          <div id="privacy-policy" className="space-y-2">
            <h3 className="text-lg">15. Privacy Policy</h3>
            <p>
              ...
              disclosure that differ from applicable laws in Belgium, then
              through your continued use of the Services, you are transferring
              your data to Belgium, and you expressly consent to have your data
              transferred to and processed in Belgium.
            </p>
          </div>
          <div id="term-termination" className="space-y-2">
            <h3 className="text-lg">16. Term and Termination</h3>
            <p>
          ...
          <div id="modifications-interruptions" className="space-y-2">
            <h3 className="text-lg">17. Modifications and Interruptions</h3>
            <p>
          ...
          <div id="governing-law" className="space-y-2">
            <h3 className="text-lg">18. Governing Law</h3>
            <p>
              These Legal Terms are governed by and interpreted following the
              laws of Belgium, and the use of the United Nations Convention of
              ...
              Paymind and yourself both agree to submit to the non-exclusive
              jurisdiction of the courts of West-Vlaanderen, which means that
              you may make a claim to defend your consumer protection rights in
              regards to these Legal Terms in Belgium, or in the EU country in
              which you reside.
            </p>
          </div>
          <div id="dispute-resolution" className="space-y-2">
            <h3 className="text-lg">19. Dispute Resolution</h3>
            <p>
              ...
              having its seat in Strasbourg, and which are in force at the time
              the application for arbitration is filed, and of which adoption of
              this clause constitutes acceptance. The seat of arbitration shall
              be Bruges, Belgium. The language of the proceedings shall be
              Dutch. Applicable rules of substantive law shall be the law of
              Belgium. Restrictions The Parties agree that any arbitration shall
              ...
              piracy, invasion of privacy, or unauthorised use; and (c) any
          ...
          <div id="corrections" className="space-y-2">
            <h3 className="text-lg">20. Corrections</h3>
            <p>
          ...
          <div id="disclaimer" className="space-y-2">
            <h3 className="text-lg">21. Disclaimer</h3>
            <p>
          ...
          <div id="limitations-of-liability" className="space-y-2">
            <h3 className="text-lg">22. Limitations of Liability</h3>
            <p>
              ...
              PAID, IF ANY, BY YOU TO US DURING THE TWO (2) MONTH PERIOD PRIOR
          ...
          <div id="indemnification" className="space-y-2">
            <h3 className="text-lg">23. Indemnification</h3>
            <p>
          ...
          <div id="user-data" className="space-y-2">
            <h3 className="text-lg">24. User Data</h3>
            <p>
          ...
          <div id="electronic-communications" className="space-y-2">
          ...
          <div id="miscellaneous" className="space-y-2">
            <h3 className="text-lg">26. Miscellaneous</h3>
            <p>
          ...
          <div id="contact-us" className="space-y-2">
            <h3 className="text-lg">27. Contact Us</h3>
            <p>
              In order to resolve a complaint regarding the Services or to
              receive further information regarding use of the Services, please
              contact us at: Paymind Bruges, West-Vlaanderen 8310 Belgium,
              info@paymind.be
            </p>
          </div>
        </section>
