      ...
      <div className="container flex flex-col gap-4">
        <section>
          ...
          <p className="text-xs sm:text-sm text-muted-foreground">
            Last updated 01/05/2024 This privacy notice for Paymind
            ...
            (&quot;Services&quot;), such as when you: Questions or concerns?
        ...
        <section>
          <h2 className="font-heading text-xl">Summary of key points</h2>
          <p className="text-xs sm:text-sm text-muted-foreground">
            ...
            receive any information from third parties? We may receive
            ...
            about when and with whom we share your personal information. What
            ...
            rights. How do you exercise your rights? The easiest way to exercise
        ...
        <section>
          ...
          <ul className="list-disc pl-4 space-y-2">
            <li>
              <a href="#what">1. What information do we collect?</a>
            </li>
            <li>
              <a href="#how">2. How do we process your information?</a>
            </li>
            <li>
              <a href="#when-who">
        ...
        <section className="space-y-4 text-sm md:text-base">
          <div id="what" className="space-y-2">
            <h3 className="text-lg">1. What information do we collect?</h3>
            <p>
          ...
          <div id="how" className="space-y-2">
            <h3 className="text-lg">2. How do we process your information?</h3>
            <p>
          ...
          <div id="when-who" className="space-y-2">
            ...
            <p>
              ...
              control with us. Business Partners. We may share your information
              with our business partners to offer you certain products,
              services, or promotions.
            </p>
          </div>
          <div id="cookies" className="space-y-2">
            <h3 className="text-lg">
              4. Do we use cookies and other tracking technologies?
            </h3>
            <p>
          ...
          <div id="social-logins" className="space-y-2">
            <h3 className="text-lg">5. How do we handle your social logins?</h3>
            <p>
              ...
              you. Our Services offer you the ability to register and log in
          ...
          <div id="international-transfer" className="space-y-2">
            <h3 className="text-lg">
              6. Is your information transferred internationally?
            </h3>
            <p>
              We may transfer, store, and process your information in countries
              other than your own. Our servers are located in. If you are
              ...
              countries. If you are a resident in the European Economic Area
              (EEA), United Kingdom (UK), or Switzerland, then these countries
              may not necessarily have data protection laws or other similar
              laws as comprehensive as those in your country. However, we will
              take all necessary measures to protect your personal information
              in accordance with this privacy notice and applicable law.
            </p>
          </div>
          <div id="data-retention" className="space-y-2">
            <h3 className="text-lg">
              7. How long do we keep your information?
            </h3>
            <p>
              ...
              by law. We will only keep your personal information for as long as
          ...
          <div id="minors" className="space-y-2">
            <h3 className="text-lg">
              8. Do we collect information from minors?
            </h3>
            <p>
              We do not knowingly collect data from or market to children under
              18 years of age. We do not knowingly solicit data from or market
              ...
              age 18, please contact us at info@paymind.be.
            </p>
          </div>

          <div id="privacy-rights" className="space-y-2">
            <h3 className="text-lg">9. What are your privacy rights?</h3>
            <p>
              ...
              NOTICE?&quot; below. However, please note that this will not
              ...
              grounds other than consent. Account Information If you would at
              any time like to review or change the information in your account
              or terminate your account, you can: Upon your request to terminate
          ...
          <div id="do-not-track" className="space-y-2">
            <h3 className="text-lg">10. Controls for do-not-track features</h3>
            <p>
          ...
          <div id="updates" className="space-y-2">
            <h3 className="text-lg">11. Do we make updates to this notice?</h3>
            <p>
              ...
              privacy notice, we may notify you either by prominently emailing a
          ...
          <div id="contact" className="space-y-2">
            ...
            <p>
              ...
              contact us by email at: info@paymind.be
            </p>
          </div>
          <div id="review-update-delete" className="space-y-2">
            <h3 className="text-lg">
